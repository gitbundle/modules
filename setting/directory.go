...
func PrepareAppDataPath() error {
	...
	// For example, if someDir=/mnt/vol1/gitbundle-home/data, if the mount point /mnt/vol1 is not mounted when GitBundle runs,
	// then gitbundle will make new empty directories in /mnt/vol1, all are stored in the root filesystem.
